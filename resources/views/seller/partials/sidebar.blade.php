<x-sidebar>
    ...
    <x-sidebar-link href="{{ route('seller.shop.edit') }}" :active="request()->routeIs('seller.shop.*')">
    ...
    <x-sidebar-link href="{{ route('seller.discounts.index') }}" :active="request()->routeIs('seller.discounts.*')">
    ...
    <x-sidebar-link href="{{ route('seller.reports.index') }}" :active="request()->routeIs('seller.reports.*')">
