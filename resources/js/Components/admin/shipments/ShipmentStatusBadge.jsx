...
const statusConfig = {
    ...
    packed:           { label: 'Ready for Pickup', bg: 'bg-orange-500/15',  text: 'text-orange-400',  border: 'border-orange-500/25', dot: 'bg-orange-400'  },
    out_for_delivery: { label: 'Out for Delivery', bg: 'bg-purple-500/15',  text: 'text-purple-400',  border: 'border-purple-500/25', dot: 'bg-purple-400'  },
