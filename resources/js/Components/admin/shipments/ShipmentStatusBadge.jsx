...
const statusConfig = {
    ...
    preparing:  { label: 'Preparing',  bg: 'bg-blue-500/15',    text: 'text-[#E60012]',    border: 'border-blue-500/25',  dot: 'bg-blue-400'    },
    shipped:    { label: 'Shipped',    bg: 'bg-indigo-500/15',  text: 'text-indigo-400',  border: 'border-indigo-500/25',dot: 'bg-indigo-400'  },
    in_transit: { label: 'In Transit', bg: 'bg-blue-100',    text: 'text-[#E60012]',    border: 'border-blue-200',  dot: 'bg-blue-400'    },
