                                ...
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        ...
                                        <select
                                            ...
                                            className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-black focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all"
                                        >
