                                ...
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black/10 focus:border-emerald-500/50 transition-all"
                                        />
                                    </div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        ...
                                        <select
                                            ...
                                            className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-black focus:outline-none focus:ring-2 focus:ring-black/10 focus:border-emerald-500/50 transition-all"
                                        >
