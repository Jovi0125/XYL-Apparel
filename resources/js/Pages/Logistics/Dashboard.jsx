...
export default function Dashboard({ stats, shipments }) {
    ...
    const statCards = [
        { label: 'Pending', value: stats.pending, accent: 'border-l-yellow-400', filter: 'pending' },
        { label: 'Preparing', value: stats.preparing, accent: 'border-l-blue-400', filter: 'preparing' },
        { label: 'In Transit', value: stats.in_transit, accent: 'border-l-purple-400', filter: 'shipped' },
        { label: 'Delivered', value: stats.delivered, accent: 'border-l-emerald-400', filter: 'delivered' },
        { label: 'Cancelled', value: stats.cancelled, accent: 'border-l-red-400', filter: 'cancelled' },
        { label: 'Total Orders', value: stats.total, accent: 'border-l-black', filter: 'all' },
    ];
                ...
                {statusFilter !== 'all' && (
                    <div className="flex items-center gap-2">
                        <span className="text-xs text-gray-400">
                            Filtered by: <span className="font-semibold text-black">{statusFilter.toUpperCase()}</span>
                        </span>
                        <button 
