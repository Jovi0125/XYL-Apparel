...
export default function CategoriesEdit() {
    ...
    useEffect(() => {
        axios.get(`/admin/categories/${id}/edit`).then(res => {
            const cat = res.data.category;
            setForm({ name: cat.name || '', parent_id: cat.parent_id || '', description: cat.description || '', image: null, sort_order: cat.sort_order || 0, is_active: !!cat.is_active });
    ...
    return (
        <DashboardLayout sidebar={<AdminSidebar />} pageTitle="Edit Category">
