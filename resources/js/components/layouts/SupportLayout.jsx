...
const navItems = [
    { label: 'Dashboard', path: '/support/dashboard', icon: '📊' },
    { label: 'Tickets', path: '/support/tickets', icon: '🎫' },
];

export default function SupportLayout({ children, title }) {
        ...
        <div className="flex min-h-screen bg-gray-50">
            <aside className="w-64 bg-purple-900 text-white flex flex-col">
                <div className="px-6 py-5 border-b border-purple-700">
                    <h2 className="text-xl font-bold tracking-wide">XYLO Support</h2>
                </div>
                ...
                <div className="px-3 py-4 border-t border-purple-700">
                    <form method="POST" action="/logout">
                        ...
                        <button type="submit" className="w-full text-left px-4 py-2 text-sm text-purple-300 hover:text-white transition">
                            🚪 Logout
                        </button>
                    </form>
                </div>
